...
import { ResolvedTokenAddressInstruction } from '../types';
/**
 ...
 * @returns
 */
export declare function resolveOrCreateAssociatedTokenAddress(connection: Connection, owner: PublicKey, tokenMint: PublicKey, wrappedSolAmountIn?: u64): Promise<ResolvedTokenAddressInstruction>;
export declare function createAssociatedTokenAddress(connection: Connection, owner: PublicKey, tokenMint: PublicKey, wrappedSolAmountIn?: u64): Promise<ResolvedTokenAddressInstruction>;
